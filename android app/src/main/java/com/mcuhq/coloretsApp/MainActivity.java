...
import com.mcuhq.coloretsApp.biblio.Biblio;
import com.mcuhq.coloretsApp.Manifest;
import com.mcuhq.coloretsApp.R;
import com.mcuhq.coloretsApp.amazonaws.mobile.util.JSONUtilsFile;
...
js= new JSONUtilsFile();
        ...
        AWSMobileClient.getInstance().initialize(this, new AWSStartupHandler() {
            ...
            public void onComplete(AWSStartupResult awsStartupResult) {
                Log.d("wow1", "AWSMobileClient is instantiated and you are connected to AWS!");
            }
        }).execute();
       ...
       // mLED1 = (CheckBox)findViewById(R.id.checkboxLED1);
        ...
        anarbiblio.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View v) {
                                              Intent i = new Intent(MainActivity.this,  Biblio.class);
                                              startActivity(i);
                        ...
                        if(readMessage.charAt(0)=='-')
                        {
                            if(readMessage.charAt(7)=='(')
                            {
                                if(readMessage.indexOf(')')>0) {
                                  ...
                                  col.setText("color: ("+ Integer.toString(color.r)+ ","+ Integer.toString(color.g) +","+Integer.toString(color.b)+")");
